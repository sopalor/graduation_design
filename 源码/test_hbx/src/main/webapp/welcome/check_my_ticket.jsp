							...
							<table class="table_4" cellpadding="0" cellspacing="0" rules="all" border-color="#666666">
								<tbody>
									<tr>
										...
										<td>${requestScope.ticket.UUser.CName}</td>
										<td style="width: 150px;">出发时间</td>
										<td>${requestScope.ticket.TTicket.DCfsj}</td>
									</tr>
								
									<tr>
										<td>出发城市</td>
										<td>${requestScope.ticket.TTicket.CCfd}</td>
										<td>到达城市</td>
										<td>${requestScope.ticket.TTicket.CMdd}</td>
									</tr>
									<tr>
										<td>航班号</td>
										<td>${requestScope.ticket.TTicket.CHkgs}</td>
										<td>座位号</td>
										<td>${requestScope.ticket.NSit}</td>
									</tr>
										<tr>
										<td>身份证号码</td>
										<td colspan="3">${requestScope.ticket.UUser.CSfzh}</td>
